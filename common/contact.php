<section class="p-contact l-section">
  <div class="p-contact__inner l-section__inner">
    <h4 class="p-contact__heading">まずは無料で資料請求から</h4>
    <a href="<?php echo esc_url(home_url("form")); ?>" class="p-contact__btn">資料請求</a>
    <a href="<?php echo esc_url(home_url("form")); ?>" class="p-contact__link">お問い合わせ</a>
  </div>
</section>
